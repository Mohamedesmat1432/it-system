...
<?php $component->withAttributes(['wire:model' => 'edit_modal','submit' => 'save()','method' => 'PATCH']); ?>
         <?php $__env->slot('title', null, []); ?> 
            <?php echo e(__('site.update_sub_problem')); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.select','data' => ['class' => 'mt-1 block w-full','wire:model' => 'problem_id']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'mt-1 block w-full','wire:model' => 'problem_id']); ?>
...
</div><?php /**PATH /var/www/resources/views/livewire/sub-problem/update-sub-problem.blade.php ENDPATH**/ ?>
...
<?php $component->withAttributes(['wire:model' => 'create_modal','submit' => 'save()','method' => 'POST']); ?>
             <?php $__env->slot('title', null, []); ?> 
                <?php echo e(__('site.create_sub_problem')); ?>
...
<?php endif; ?>
                        <div wire:ignore.self x-data="{ problem_id: <?php if ((object) ('problem_id') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('problem_id'->value()); ?>')<?php echo e('problem_id'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('problem_id'); ?>')<?php endif; ?> }" x-init="() => {
                            $nextTick(() => {
                                ...
                                select.select2({
                                    tags: true,
                                    dropdownParent: $('body'),
                                    placeholder: '<?php echo e(__('site.select_problem')); ?>',
                                    allowClear: true,
...
<?php /**PATH /var/www/resources/views/livewire/sub-problem/create-sub-problem.blade.php ENDPATH**/ ?>
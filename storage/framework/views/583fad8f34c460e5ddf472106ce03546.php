...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input','data' => ['type' => 'text','class' => 'mt-1 block w-full','wire:model' => 'name','placeholder' => ''.e(__('site.name')).'','autocomplete' => 'department-name']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'text','class' => 'mt-1 block w-full','wire:model' => 'name','placeholder' => ''.e(__('site.name')).'','autocomplete' => 'department-name']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>

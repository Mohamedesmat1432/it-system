...
#[Layout('layouts.app')]
class ImportIp extends Component
{
    use IpTrait, WithFileUploads;
    ...
    public function import(IpsImport $import)
    {
        ...
        try {
            ...
            $this->successNotify(__('site.ip_imported'));
    ...
    {
        $this->authorize('import-ip');

        return view('livewire.ip.import-ip');
    }
}

...
#[Layout('layouts.app')]
class ImportRack extends Component
{
    use RackTrait, WithFileUploads;
    ...
    public function import(RacksImport $import)
    {
        ...
        try {
            ...
            $this->successNotify(__('site.rack_imported'));
    ...
    {
        $this->authorize('import-rack');

        return view('livewire.rack.import-rack');
    }
}

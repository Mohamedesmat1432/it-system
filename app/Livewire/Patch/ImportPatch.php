...
#[Layout('layouts.app')]
class ImportPatch extends Component
{
    use PatchTrait, WithFileUploads;
    ...
    public function import(PatchsImport $import)
    {
        ...
        try {
            ...
            $this->successNotify(__('site.patch_imported'));
    ...
    {
        $this->authorize('import-patch');

        return view('livewire.patch.import-patch');
    }
}
